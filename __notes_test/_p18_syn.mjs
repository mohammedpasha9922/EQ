...
smartScanReviewNote: 'दस्तावेज़ पहचान लिया गया है। PDF बनाने से पहले सामग्री की समीक्षा करें।',
    smartScanStatusNeeds: 'समीक्षा आवश्यक',
    smartScanStatusEdited: 'संपादित: आपके सुधार PDF में उपयोग होंगे',
